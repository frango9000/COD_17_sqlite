 ...
 * @author NarF
 */
public final class EditorialFrame extends javax.swing.JFrame {
    ...
    public EditorialFrame(Integer id) {
        ...
        if (id != null) {
            ...
            jTextFieldName.setText(biblioSQL.getEditoriales().get(id));
        }
    ...
    private void jBtnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAcceptActionPerformed
        ...
        if (jTextFieldID.getText().length() == 0) {
            if (jTextFieldName.getText().trim().length() > 0) {
                if (biblioSQL.insertEditorial(jTextFieldName.getText().trim()) > 0) {
                    EditorialesPanel.refreshTable();
            ...
            if (jTextFieldName.getText().trim().length() > 0) {
                if (biblioSQL.updateEditorial(Integer.parseInt(jTextFieldID.getText()), jTextFieldName.getText().trim()) > 0) {
                    EditorialesPanel.refreshTable();
